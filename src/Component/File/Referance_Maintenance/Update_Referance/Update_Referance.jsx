...
function Update_Referance() {
  ...
  useEffect(() => {
    fetch(`${apiLinks}/GetReference.php?refid=${refid}`)
      .then((response) => response.json())
      .then((apiData) => {
        const user = apiData.find((item) => item.refid === refid);
        setUser(user);
      })
  ...
  const handleSubmit = (event) => {
    ...
    requestBody.append("id", user.refid);
    requestBody.append("Refdsc", user.refdsc);
    requestBody.append("RefSts", user.refsts);

    axios
      .post(`${apiLinks}/UpdateReference.php?refid=${refid}`, requestBody)
      .then((response) => {
  ...
  return (
    <>
      ...
      >
        ...
        <PathHead
          pageName="File > Referance Maintenance > Update Referance"
          screen="Update_Item"
...
export default Update_Referance;
