...
<PathHead pageName="File > Delivery Maintenance > Add Delivery" />
  ...
  <div className="col-6">
    ...
    <Form.Group controlId="description" style={{ display: 'flex', alignItems: 'center' ,marginTop:'-2%'}}>
      <Form.Label style={{ marginRight: '10px', marginLeft: '17px' }}>Amount:</Form.Label>
      <Form.Control
        type="text"
        placeholder="Amount "
        name="dvamtt"
        ...
        onChange={handleInputChange}
        style={{ height: '20px', width: '70px' , textAlign: 'right' }}
      />
    </Form.Group>
    <Form.Group controlId="status" style={{ display: 'flex', alignItems: 'center' ,marginTop:'-1%'}}>
      <Form.Label style={{ marginRight: '13px', marginLeft: '27px', textAlign: 'right' }}>Status:</Form.Label>
      <Form.Control
        as="select"
        name="dvstss"
