...
function Update_Item() {
  ...
  useEffect(() => {
    fetch(`${apiLinks}/GetItem.php?itmid=${itmid}`)
      .then((response) => response.json())
      .then((apiData) => {
        const user = apiData.find((item) => item.itmid === itmid);
        setUser(user);
      })
  ...
  const handleSubmit = (event) => {
    ...
    requestBody.append("id", user.itmid);
    requestBody.append("itmDsc", user.itmdsc);
    requestBody.append("itmSts", user.itmsts);

    axios
      .post(`${apiLinks}/UpdateItem.php?itmid=${itmid}`, requestBody)
      .then((response) => {
  ...
  return (
    <>
      ...
      >
        ...
        <PathHead
          pageName="File > Item Maintenance > Update Item"
          screen="Update_Item"
          pageLink="/Get_Item"
        />
