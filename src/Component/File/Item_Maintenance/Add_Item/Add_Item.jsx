...
function Add_Item() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      formData.append(" itmDsc", values.itmDscc);
      formData.append(" itmSts", value.itmStss);

      axios
        .post(
          // `${apiLinks}/add_category.php`,
          `${apiLinks}/ItemMaintenance.php`,
