...
function Update_TechnicianVisit() {
  ...
  const handleFormSubmit = (event) => {
    ...
    axios
      .post(`${apiLinks}/FollowUp.php`, requestBody)
      .then((response) => {
  ...
  return (
    <>
      ...
      >
        ...
        <PathHead
          pageName="Transaction > Technician Visit > Update Technician Visit"
          screen="Item"
          pageLink="/Technician_Visit"
        />
...
export default Update_TechnicianVisit;
